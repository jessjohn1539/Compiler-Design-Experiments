...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','exp7.py',40),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','exp7.py',45),
  ('expression -> term','expression',1,'p_expression_term','exp7.py',50),
  ('term -> term TIMES factor','term',3,'p_term_times','exp7.py',54),
  ('term -> term DIVIDE factor','term',3,'p_term_divide','exp7.py',59),
  ('term -> factor','term',1,'p_term_factor','exp7.py',64),
  ('factor -> NUMBER','factor',1,'p_factor_number','exp7.py',68),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_group','exp7.py',73),
]
